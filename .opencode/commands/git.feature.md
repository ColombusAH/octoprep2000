---
description: Create a feature branch with sequential or timestamp numbering, optionally
...
Create a new git feature branch for the given specification, optionally isolated in its own worktree. This command handles **branch creation only** — the spec directory and files are created by the core `/spec.specify` workflow.
